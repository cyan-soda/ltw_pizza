                ...
                <div class="col-md-6 detail-column">
                    ...
                    <div class="col-md-6 detail-column">
                        ...
                        <div>
                            ...
                            <select class="form-select" aria-label="Default select example" id="provinceSelect" onchange="updateDistricts()">
            ...
            <div class="row gx-5">
                            ...
                            <div class="payment-method-container">
                                <div class="col-12 choice">
                                    ...
                                    <label for="momo">
                                        <div class="row payment-name-container">
                                            <div class="col-2 payment-method-icon align-self-center" style="border-right: 1px solid rgb(203, 202, 202);">
                                                <img class="delivery-icon mx-auto p-2" src="public/img/momo.jpeg" alt="momo-icon">
                                            </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <label for="momo">
                                        <div class="row payment-name-container">
                                            <div class="col-2 payment-method-icon align-self-center" style="border-right: 1px solid rgb(203, 202, 202);">
                                                <img class="delivery-icon mx-auto p-2" src="public/img/cash.jpeg" alt="momo-icon">
                                            </div>
                ...
                <div class="col-md-4 payment-choice-container">  
                    ...
                    <div class="row total-price-area">
                        ...
                        <p class="col text-end total-price">99000VND</p>
                    </div>
                </div>
            </div>
                ...
                <div>
                    <div id="ship" class="row" onclick="changeColor('ship','seft-take)">
                        <div class="col-3 icon-container">
                            <img class="delivery-icon mx-auto p-2" src="public/img/delivery_icon.png" alt="delivery-icon">
                        </div>

                        <div class="col-9 align-self-center">
                            <p class="method-choice-title">Đặt giao hàng</p>
                            <p>Giao hàng tận nơi với đơn hàng <span class="emphasized">thực thanh toán</span> từ <span class="emphasized">100.000đ</span>. Phụ thu phí giao hàng từ <span class="emphasized">25,000đ</span> cho mỗi đơn đặt hàng qua Hotline 19006066 hoặc Website, bao gồm hoá đơn có các sản phẩm thuộc chương trình khuyến mại.</p>
                        </div>
                    </div>
                </div>
            </div>
