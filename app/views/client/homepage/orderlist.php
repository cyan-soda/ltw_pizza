...
<div class="orderpage">
    ...
    <div class="tableorder">
       <div class="rowproduct">
            <div class="orderleft row col-6">
                <div class="order_productimage col-4">
                ...
                <div class="order_productinfor col-8">
                    <div class="order_product_inforname">Tên này</div>
                    <div class="order_product_select">Thuộc tính ở đây nè</div>
                </div>
            </div>
            <div class="orderright row col-6">
                <div class="order_productamount col-3">
                ...
                <div class="order_productdelete col-4">
